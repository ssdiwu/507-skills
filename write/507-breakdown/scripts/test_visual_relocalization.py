...
apply_visual_matches(ws,[{'semanticUnit':'u','pts':3.0,'description':'A blue screen fills the frame.','anchorChecks':[{'anchor':'blue screen','visible':True}]}],video)
...
apply_visual_matches(ws,[{'semanticUnit':'u','pts':3.0,'description':'The blue screen is NOT visible.','anchorChecks':[{'anchor':'blue screen','visible':False}]}],video)
