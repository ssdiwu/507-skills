...
def anchor_match(anchor:str,text:str)->bool:
 ...
 if not anchor or re.search(r"\b(?:might|possibly|maybe|could|unclear|absent|report|article|states|asked|whether|actual|claimed|there)\b|未出现|没有出现|实际画面|引用",text): return False
