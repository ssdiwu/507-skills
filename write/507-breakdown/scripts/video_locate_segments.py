...
def anchor_match(anchor:str,text:str)->bool:
 ...
 if re.search(r"\b(?:not|no|without|cannot|can't|doesn't|never|nowhere|invisible|hidden|fake|absent|unclear|maybe|might|possibly|could|hardly)\b|不是|未出现|没有出现|并未|看不到|不可见|隐藏|假的",text): return False
